...
var $author$project$Ports$LocalStorage$saveToLocalStorage = _Platform_outgoingPort(
	'saveToLocalStorage',
	function ($) {
...
var $author$project$Main$OnTextBoxChange = function (a) {
	return {$: 'OnTextBoxChange', a: a};
};
...
var $author$project$Main$readyView = function (value) {
	return A2(
		$mdgriffith$elm_ui$Element$el,
		_List_fromArray(
			[
		...
		A2(
			...
			_List_fromArray(
				[$mdgriffith$elm_ui$Element$centerX]),
			{
				label: $mdgriffith$elm_ui$Element$Input$labelHidden('textbox'),
				onChange: $author$project$Main$OnTextBoxChange,
				...
				A2(
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[$mdgriffith$elm_ui$Element$centerX, $mdgriffith$elm_ui$Element$centerY]),
							$mdgriffith$elm_ui$Element$text('I remember whatever you tell me...')),
							function () {
							if (model.$ === 'Loading') {
								return $author$project$Main$loadingView;
							} else {
								var record = model.a;
								return $author$project$Main$readyView(record);
							}
						}()
						])))
			]),
